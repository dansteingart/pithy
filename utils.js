...
import sqlitePersistence from './sqlitepersist.js'

const useSQLite = true; // or use a config flag
    ...
    bindState: async (docName, ydoc) => {
      ...
      ydoc.on('update', update => {
        ldb.storeUpdate(docName, update)
            ...
            // Additionally, store the full state in SQLite.
...
export class WSSharedDoc extends Y.Doc {
  ...
  constructor (name) {
    ...
    // this.on('update', () => {
    //   console.log("Full document update:", this.getText('monaco').toString())
    // })

        // Write to the database on every update:
        this.on('update', () => {
          sqlitePersistence.writeState(this.name, this)
            .then(() => {
              //console.log("Database updated for doc:", this.name)
            })
            .catch(err => {
              console.error("Error updating database for doc:", this.name, err)
            })
        })
